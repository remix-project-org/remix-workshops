...
2. Put the value (in Wei) you want to send to the contract in "VALUE", then click "Transact". 
    ![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/19_Fallback_en/step1/img/19-1.jpg)

3. The transaction succeeded, and the "receivedCalled" event emitted. 
    ![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/19_Fallback_en/step1/img/19-2.jpg)

4. Put the value you want to send to the contract in "VALUE", and put any valid `msg.data` in "CALLDATA", and click "Transact". 
    ![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/19_Fallback_en/step1/img/19-3.jpg)
    
5. The transaction succeeded, and the "fallbackCalled" event emitted. "fallbackCalled". 
    ![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/19_Fallback_en/step1/img/19-4.jpg)
