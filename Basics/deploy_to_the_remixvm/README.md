...
1. Click the Deploy and Run icon ![deploy & run icon](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/Basics/deploy_to_the_remixvm/images/run.png "deploy & run icon").  
