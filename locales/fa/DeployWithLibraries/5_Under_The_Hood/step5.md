به ماژول `کامپایلر سالیدیتی` سوئیچ کنید![کامپایلر سالیدیتی](https://github.com/ethereum/remix-workshops/raw/master/DeployWithLibraries/2_Generate_Metadata/remix_icon_solidity.png "کامپایلر سالیدیتی")
