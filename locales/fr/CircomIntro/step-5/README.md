...
- **Configuration de confiance :** Un processus requis pour que zk-SNARK génère les paramètres nécessaires à la génération et à la vérification des preuves.
...
2. Choose the appropriate **Power of Tau** file from the dropdown. This file is necessary for the trusted setup.
   - Si vous n'êtes pas sûr, sélectionnez l'option par défaut.
