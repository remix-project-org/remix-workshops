...
![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/52_EIP712_en/step1/img/52-1.png)
...
![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/52_EIP712_en/step1/img/52-2.png)
...
3. Create a `message` variable and pass in the typed data to be signed.
    ...
    ```
    ![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/52_EIP712_en/step1/img/52-3.png)
...
4. Call the `signTypedData()` method of the wallet object, passing in the `domain`, `types`, and `message` variables from the previous step for signature (`ethersjs v6` is used here).
    ...
    // Get provider
     ...
     ```
     ![](https://raw.githubusercontent.com/remix-project-org/remix-workshops/master/52_EIP712_en/step1/img/52-4.png)
